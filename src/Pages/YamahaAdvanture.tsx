...
import YamahaRally4 from "../assets/YamahaRally4.png";
import YamahaRally5 from "../assets/YamahaRally5.png";
import RallyVedio from "../assets/RallyVedio.mp4";
    ...
    <div className="w-full min-h-screen bg-gray-900 text-gray-200">
      ...
      <div className="max-w-6xl mx-auto px-4 mt-16">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
          {[YamahaRally4, YamahaRally3, YamahaRally2, YamahaRally5].map(
            (img, index) => (
              <img
                key={index}
                src={img}
      ...
      {selectedImage && (
        <div className="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center z-50">
          {/* CLOSE BUTTON */}
          <button
            className="absolute top-4 right-4 text-white text-3xl sm:text-4xl font-bold focus:outline-none"
